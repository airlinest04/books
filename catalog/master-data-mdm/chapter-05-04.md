...
Подход «ручной»: проектирование правил, реализация в SQL/ETL, поддержка и доработка. MDM-платформы дают готовые функции сопоставления и слияния, но требуют лицензий и интеграции; в рамках книги достаточен уровень SQL + ETL. См. [TOC](README.md), введение книги.
